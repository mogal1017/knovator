  ...
  const getData = async () => {
    try {
      ...
      if (responseData.data && responseData.data.length > 0) {
        ...
        setEditorData(data.privacy_policy);
      }
    } catch (error) {
  ...
  const handleButtonClick = async () => {
    ...
    try {
      const payload = {
        ...
        id: 1,
        inputData: {
          privacy_policy: formattedContent,
        },
      };
      console.log(
        "Formatted payload for the CK editor in Privacy Policy===>",
        payload
      );
            ...
            <Col>
              <Card>
                <CardHeader className="align-items-center d-flex">
                  <h4 className="card-title mb-0">Privacy Policy Editor</h4>
                </CardHeader>
                <CardBody>
                  <Form method="post">
                    <CKEditor
