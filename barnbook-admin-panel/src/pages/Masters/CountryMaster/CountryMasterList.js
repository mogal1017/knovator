...
export default function CountryMasterList() {
    ...
    const handleEdit = (id) => {
      navigate(`/country-master-create/${id}`);
    };
    ...
    const handleToggleStatus = async (id, currentStatus) => {
      try {
        ...
        // return false;
        const response = await fetchData("api/masters/updateCountry", payload);
        if (response.code === 1) {
          setData((prevData) =>
            prevData.map((item) =>
    ...
    const columns = useMemo(
      () => [
        ...
        {
          Header: "Country Name",
          accessor: (row) => (row.country_name ? row.country_name : "-"),
          disableFilters: true,
          filterable: false,
        },
        {
          ...
          <Container fluid>
            ...
            >
              ...
              <Button
                  ...
                  onClick={()=>navigate("/country-master-create")}
