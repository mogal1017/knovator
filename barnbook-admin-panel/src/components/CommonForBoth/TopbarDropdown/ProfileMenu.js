            ...
            <React.Fragment>
                <Dropdown isOpen={this.state.menu} toggle={this.toggle} className="d-inline-block user-dropdown">
                    ...
                    <DropdownMenu className="dropdown-menu-end">
                        ...
                        <DropdownItem className="text-danger" onClick={()=> localStorage.removeItem('token')} href="/"><i className="ri-shut-down-line align-middle me-1 text-danger"></i> {this.props.t('Logout')}</DropdownItem>
                    </DropdownMenu>
                </Dropdown>
            </React.Fragment>
        );
