...
module.exports = (sequelize, DataTypes) => {
  class user_tax_documents extends Model {
    /**
  ...
  user_tax_documents.init({
    ...
    file_type: {
      ...
      get() {
        ...
        const ext = path.extname(this.document_url).toLowerCase(); // Get file extension
        switch (ext) {
          case '.pdf':
            return 'PDF';
          case '.jpg':
    ...
    sequelize,
    modelName: 'user_tax_documents',
  });
  return user_tax_documents;
};